...
\begin{column}{0.47\textwidth}
  \centering
  \textbf{\small Fund Family Marketing}\\[6pt]
  \includegraphics[width=0.82\textwidth]{pictures/tiantian_portal.jpg}\\[6pt]
  {\small
  Fund families compete for \hl{platform real estate}:\\[3pt]
  \begin{itemize}\addtolength{\itemsep}{2pt}
    \item Featured slots on the livestream portal
    \item Themed series curated by platform
    \item Viewer counts and follower metrics
    \item Broadcast scheduling and archives
  \end{itemize}}
\end{column}
\begin{column}{0.47\textwidth}
  \centering
  \textbf{\small Fund Product Marketing}\\[6pt]
  \includegraphics[width=0.82\textwidth]{pictures/tiantian_products.jpg}\\[6pt]
  {\small
  Individual funds are marketed with \hl{product details}:\\[3pt]
  \begin{itemize}\addtolength{\itemsep}{2pt}
    \item ``New Issue'' or ``Featured'' status tags
    \item Full fund name, asset class, risk rating
    \item Past performance and subscription window
    \item One-click purchase from within the stream
  \end{itemize}}
\end{column}
\end{columns}

\vspace{0.15cm}
\muted{\small \textit{Question:} Fund-level marketing is clearly visible and measurable. But does it expand the family's total assets --- or merely reshuffle them?}
